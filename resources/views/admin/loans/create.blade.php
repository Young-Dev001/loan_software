    ...
    <div class="row">
        <div class="col-xl-6 col-md-6">
           <div class="card">
               <div class="card-body">
                <div class="row">
                    <form action="{{ route('loans.store') }}" method="post" enctype="multipart/form-data" id="registrationForm">
                        @csrf
                            @if ($errors->any())
                                <div class="alert alert-danger">
                                    ...
                                    <div class="row">
                                        ...
                                        <select name="member_id" id="member_id" class="form-control form-select select2">
                                            <option value="" disabled selected>--Select Member--</option>
                                            @foreach($members as $member)
                                                {{-- Fetch the group name associated with the member --}}
                                                @php
                                                    $Sub_groupName = $member->sub_group ? $member->sub_group->name : 'No Group';
                                                @endphp
                                                {{-- Include the group name alongside the member name --}}
                                                <option value="{{ $member->id }}" data-group-id="{{ $member->sub_group_id }}">{{ $member->name }} - {{ $Sub_groupName }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    {{-- Text input field to display the selected member's group_id --}}
                                        <input type="text" name="sub_group_id" id="sub_group_id" class="form-control"  hidden>
                                    ...
                                    <div class="col-lg-6">
                                     ...
                                     <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="term" class="form-control" id="term" placeholder="Enter Loan Term">
                                        </div>
                                     </div>
                                    </div>
                                     <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="number" name="loan_interest" class="form-control " id="loan_interest" readonly required>
                                        </div>
                                        </div>
                                        <div class="col-lg-6">
                                        <div class="form-group">
                                            <label for="loan_total">Loan Total:</label>
                                            <input type="number" name="loan_total" id="loan_total" class="form-control" readonly required>
                                        </div>
                                        </div>
                                     </div>
                                        <hr>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" name="payment_amount" id="payment_amount" class="form-control" readonly required>
                                                </div>
                                            </div>
