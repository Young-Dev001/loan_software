    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="card">
                    <div class="card-body">
                        <h4 class="card-title mb-4">Member Registration</h4>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="name" class="form-control" id="name" name="name" placeholder="Enter Member Full Names">
                                                    @error('name')
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" class="form-control" id="id_number" name="id_number" placeholder="Enter Member Identification No.">
                                                   @error('id_number')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                  </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="phone" class="form-control" id="phone" name="phone" placeholder="Enter Member Phone No.">
                                                   @error('phone')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                  </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="residence" name="residence" placeholder="e.g Mombasa-Nyali...">
                                                    @error('residence')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                  </div>
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="number" min="1" class="form-control" id="registration_fee" placeholder="500.00" name="registration_fee">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="postal_address" name="postal_address" placeholder="e.g P.O Box...">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" id="town" name="town" placeholder="e.g Mombasa, Kisumu, Eldoret...">
                                                    @error('town')
                                                        <div class="text-danger">{{ $message }}</div>
                                                    @enderror
                                                  </div>
                                        ...
                                        <div class="col-lg-6">
                                            <div class="text-center">
                                                ...
                                                <div>
                                                    ...
                                                    <p class="text-muted">If several languages coalesce, click the check-mark to complete!</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
